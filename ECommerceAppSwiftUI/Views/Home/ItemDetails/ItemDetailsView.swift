...
struct ItemDetailsView: View {
    ...
    var arrImage = ["sushi", "sushi", "sushi", "sushi"]
...
struct ItemDetailsView_Previews: PreviewProvider {
    static var previews: some View {
        ItemDetailsView(show: .constant(false), cloth: Cloth(name: "Master Chilaquill", description: "Toasts soaked in tomato sauce with shredded chicken, served with onion, cheese and cream", imageURL: "greenDress", price: 130, company: "Amore Mexico", rating: 4, type: "sale", isFavorite: false, discount: 40))
    }
}
