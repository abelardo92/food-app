...
struct ItemRow_Previews: PreviewProvider {
    static var previews: some View {
        ItemRow(cloth: Cloth(name: "Chilaquiles Mortales", description: "Toasts soaked in tomato sauce with shredded chicken, served with onion, cheese and cream", imageURL: "redDress", price: 150, company: "MacheteChilaquil", rating: 4, type: "sale", isFavorite: false,  discount: 40))
    }
}
